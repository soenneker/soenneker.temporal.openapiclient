...
using Soenneker.Temporal.OpenApiClient.Cluster.Namespaces.Item;
...
using System;
namespace Soenneker.Temporal.OpenApiClient.Cluster.Namespaces
{
    /// <summary>
    ...
    public partial class NamespacesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Temporal.OpenApiClient.Cluster.Namespaces.NamespacesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public NamespacesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/cluster/namespaces{?namespaceFilter%2EincludeDeleted*,nextPageToken*,pageSize*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Temporal.OpenApiClient.Cluster.Namespaces.NamespacesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public NamespacesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/cluster/namespaces{?namespaceFilter%2EincludeDeleted*,nextPageToken*,pageSize*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Temporal.OpenApiClient.Cluster.Namespaces.NamespacesRequestBuilder.NamespacesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Temporal.OpenApiClient.Cluster.Namespaces.NamespacesRequestBuilder.NamespacesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Temporal.OpenApiClient.Cluster.Namespaces.NamespacesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Temporal.OpenApiClient.Cluster.Namespaces.NamespacesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Temporal.OpenApiClient.Cluster.Namespaces.NamespacesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// ListNamespaces returns the information and configuration for all namespaces.
        /// </summary>
