...
namespace Soenneker.Temporal.OpenApiClient.Namespaces.Item.Activities.Item.Reset
{
    ...
    public partial class ResetRequestBuilder : BaseRequestBuilder
    {
        ...
        public ResetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/namespaces/{namespace}/activities/{activityId}/reset", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Temporal.OpenApiClient.Namespaces.Item.Activities.Item.Reset.ResetRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ResetRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/namespaces/{namespace}/activities/{activityId}/reset", rawUrl)
        {
        }
        /// <summary>
