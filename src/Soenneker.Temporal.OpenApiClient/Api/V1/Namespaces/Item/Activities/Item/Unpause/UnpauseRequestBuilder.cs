...
namespace Soenneker.Temporal.OpenApiClient.Api.V1.Namespaces.Item.Activities.Item.Unpause
{
    ...
    public partial class UnpauseRequestBuilder : BaseRequestBuilder
    {
        ...
        public UnpauseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/namespaces/{namespace}/activities/{activityId}/unpause", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Temporal.OpenApiClient.Api.V1.Namespaces.Item.Activities.Item.Unpause.UnpauseRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnpauseRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/namespaces/{namespace}/activities/{activityId}/unpause", rawUrl)
        {
        }
        /// <summary>
