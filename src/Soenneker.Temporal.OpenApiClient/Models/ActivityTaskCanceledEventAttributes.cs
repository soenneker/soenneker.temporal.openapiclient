...
namespace Soenneker.Temporal.OpenApiClient.Models
{
    ...
    public partial class ActivityTaskCanceledEventAttributes : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string Identity { get; set; }
#endif
        /// <summary>id of the most recent `ACTIVITY_TASK_CANCEL_REQUESTED` event which refers to the same activity</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? LatestCancelRequestedEventId { get; set; }
#nullable restore
#else
        public string LatestCancelRequestedEventId { get; set; }
#endif
        /// <summary>The id of the `ACTIVITY_TASK_SCHEDULED` event this cancel confirmation corresponds to</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string ScheduledEventId { get; set; }
#endif
        /// <summary>The id of the `ACTIVITY_TASK_STARTED` event this cancel confirmation corresponds to</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Temporal.OpenApiClient.Models.ActivityTaskCanceledEventAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Temporal.OpenApiClient.Models.ActivityTaskCanceledEventAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Temporal.OpenApiClient.Models.ActivityTaskCanceledEventAttributes();
        }
        /// <summary>
