...
namespace Soenneker.Temporal.OpenApiClient.Models
{
    ...
    public partial class CountNexusOperationExecutionsResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>If `query` is not grouping by any field, the count is an approximate number of operations that match the query. If `query` is grouping by a field, the count is simply the sum of the counts of the groups returned in the response. This number can be smaller than the total number of operations matching the query.</summary>
...
#nullable restore
        ...
        /// </summary>
        public CountNexusOperationExecutionsResponse()
        {
        ...
        public static global::Soenneker.Temporal.OpenApiClient.Models.CountNexusOperationExecutionsResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Temporal.OpenApiClient.Models.CountNexusOperationExecutionsResponse();
        }
        /// <summary>
